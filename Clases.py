    ...
    def asignarProceso(self,proceso):
        ...
        for p in self.particiones:       #Recorremos la lista de particiones
            if p.proceso is None and proceso.tamaño < p.tamaño:         #Si la particion esta vacia y el tamaño del proceso es menor que la particion     
                if mejor is None or mejor.tamaño < p.tamaño:        #Si mejor esta vacio o el tamaño de la mejor particion actual es menor al tamaño de otra particion 
...
class Planificador:    
    ...
    def siguienteProceso(self,proceso=None):
        if self.cola_de_listos:
            return self.cola_de_listos[0]        #Selecciona el primer procesos de la cola de lsitos
        return None
